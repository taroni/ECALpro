...
void pileupWeights() {
  ...
  TFile fileData("MyDataPileupHistogram.root");               // must have 75 bins for moriondMC
  TFile fileMC("/afs/cern.ch/user/c/crovelli/public/json2016/rereco/mcPUhisto___mix_2016_25ns_Moriond17MC_PoissonOOTPU.root");
