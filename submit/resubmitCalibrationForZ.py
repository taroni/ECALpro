...
print "python calibJobHandlerZ.py " + Mode + " " + str(iteration_to_resume) + " " + queue + " " + str(nJobs)
env_script_f.write("python calibJobHandlerZ.py " + Mode + " " + str(iteration_to_resume) + " " + queue + " " + str(nJobs) + "\n")
env_script_f.close()
