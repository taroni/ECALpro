...
class FitEpsilonPlotForZ : public edm::EDAnalyzer {
 public:
  enum FitMode{ Eta=0, Pt, GausPol3, GausEndpoint, ZEB, ZEE, EtaEB };
  explicit FitEpsilonPlotForZ(const edm::ParameterSet&);
  ~FitEpsilonPlotForZ();
